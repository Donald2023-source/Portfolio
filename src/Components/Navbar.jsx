...
const Navbar = () => {
    ...
    const navLinks = [{name: "Agents", path: "/agents"}, {name: "About Us", path: "/aboutUs"}, {name: "Support", path: "/support"}];
  ...
  return (
    <div className="fixed z-50 bg-white w-[100%]" onClick={handleClose}
    >
       <nav className='flex items-center justify-between lg:py-3 p-2 lg:px-7 font-semibold'>
            ...
            className='lg:h-10 h-6' src={logo} alt="" />
            </AnimatePresence>
          
          <section className='flex items-center gap-9'>
                <div>
                    <div onClick={() => setIsSelect(!isSelect)} className='lg:flex md:flex gap-6 hidden rounded-2xl items-center border w-fit p-3'>
                     <FaGlobe size={20}/>
