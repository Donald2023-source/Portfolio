...
const TopBar = ({name}) => {
    ...
    return (
        <>
            <div className="flex justify-between lg:text-normal text-sm lg:bg-white lg:text-black text-white lg:py-2 lg:mt-0 mt-3 p-10 rounded-3xl bg-myGreen px-7 lg:shadow lg:rounded-full items-center">
                <div>
